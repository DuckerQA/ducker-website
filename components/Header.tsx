...
const Header = () => {
  ...
  className="flex items-center rounded-md font-medium text-gray-900 hover:text-blue-700 dark:text-gray-100 dark:hover:text-[#a3b2ff] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-100 dark:focus-visible:ring-[#a3b2ff] dark:focus-visible:ring-offset-gray-950"
>
          ...
          {headerNavLinks
            ...
            .map((link) => {
              ...
              >
                {isActive && (
                  <span
                    className="absolute left-0 bottom-[-10px] h-[4px] w-full bg-blue-700 dark:bg-[#a3b2ff]"
                    aria-hidden="true"
                  ></span>
                )}
                {link.title}
