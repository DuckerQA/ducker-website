...
const LightDarkSwitcher = () => {
  ...
  return (
    ...
    >
      {showTooltip && (
        <motion.div
          className="absolute top-full mt-2 transform whitespace-nowrap rounded-md bg-gray-800 px-2 py-1 text-xs text-white shadow-md"
      ...
      >
        ...
        >
          ...
          <motion.path
            d="M12.4058 17.7625C15.1672 17.7625 17.4058 15.5239 17.4058 12.7625C17.4058 10.0011 15.1672 7.76251 12.4058 7.76251C9.64434 7.76251 7.40576 10.0011 7.40576 12.7625C7.40576 15.5239 9.64434 17.7625 12.4058 17.7625Z"
            stroke="#FFC857" // Zawsze ciemno-żółty
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
            style={{
          ...
          <motion.path
            d="M12.4058 17.7625C15.1672 17.7625 17.4058 15.5239 17.4058 12.7625C17.4058 10.0011 15.1672 7.76251 12.4058 7.76251C9.64434 7.76251 7.40576 10.0011 7.40576 12.7625C7.40576 15.5239 9.64434 17.7625 12.4058 17.7625Z"
            stroke="#E8A317" // Ciemniejsze żółte
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
            style={{
          ...
          {[
            ...
            'M18.7656 18.7656L20.1856 20.1856',
            'M1.40576 12.7625H3.40576',
            'M21.4058 12.7625H23.4058',
            'M6.04598 19.1225L4.62598 20.5425',
            'M20.1856 4.98248L18.7656 6.40248',
          ].map((d, i) => (
            <motion.path
              key={i}
              d={d}
